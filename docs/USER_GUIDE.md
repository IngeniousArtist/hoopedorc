...
Ubuntu LTS. The ordered deploy-day path, including AWS/Tailscale steps the
checklist assumes, is in [`docs/EC2_DEPLOY_RUNBOOK.md`](EC2_DEPLOY_RUNBOOK.md).
Clone straight to its
...
1. **Size the instance.** ≥2GB RAM (or a smaller instance plus swap — the
   ...
   **Node 22** (`engines.node` requires ≥20; 22 is what this project is
   ...
   [GitHub's official Linux install docs](https://github.com/cli/cli#installation),
