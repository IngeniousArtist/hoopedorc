...
This document records the requested product direction and implementation sequence after inspecting the running UI, source, tests, and historical roadmap. It is the focused specification for Part 14 of [PRODUCTIZATION_PLAN.md](PRODUCTIZATION_PLAN.md#part-14--visual-development-workspace). All VW implementation items remain not started. This documentation change does not implement runtime behavior or approve unresolved authentication, isolation, or compatibility choices.
